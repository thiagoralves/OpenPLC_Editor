...
extern uint8_t pinMask_AOUT[];
    ...
    extern "C" void cloud_add_bool(char *, char *);
    ...
    void cloud_add_bool(char *var_name, char *bool_var)
    {
        //ArduinoCloud.addPropertyReal((bool)(*bool_var), String(var_name), Permission::ReadWrite, ON_CHANGE, onBlank);
        bool test = (bool)(*bool_var);
        ArduinoCloud.addPropertyReal(test, String(var_name));
    }
    
    void cloud_add_int(char *var_name, int *int_var)
    {
        //ArduinoCloud.addPropertyReal(int_var, String(var_name), Permission::ReadWrite, ON_CHANGE, onBlank);
    }
    
    void cloud_add_float(char *var_name, float *float_var)
    {
        //ArduinoCloud.addPropertyReal(float_var, String(var_name), Permission::ReadWrite, ON_CHANGE, onBlank);
    }
